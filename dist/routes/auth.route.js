import { registerHandler, loginHandler, sessionHandler, profileHandler, forgotPasswordHandler, resetPasswordHandler, changePasswordHandler, sendOtpHandler, verifyOtpHandler, setupPinHandler, changePinHandler, forgotPinHandler, } from '../controllers/auth.controller.js';
...
async function notificationsHandler(request, reply) {
    return reply.send({ notifications: [] });
}
async function markNotifReadHandler(request, reply) {
    return reply.send({ message: 'Notification marked as read' });
}
async function onboardingStubHandler(request, reply) {
